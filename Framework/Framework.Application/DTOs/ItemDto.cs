...
// 아이템 생성 요청 DTO
public record CreateItemDto(string Name, ItemType ItemType, string Description);

// 아이템 수정 요청 DTO
public record UpdateItemDto(string Name, ItemType ItemType, string Description);
