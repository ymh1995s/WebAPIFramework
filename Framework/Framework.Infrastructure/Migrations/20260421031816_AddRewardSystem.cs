    ...
    public partial class AddRewardSystem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyLoginLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyLoginLogs_PlayerRecords_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyRewardConfigs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyRewardConfigs_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Mails_PlayerRecords_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "PlayerRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerItems_PlayerRecords_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "PlayerRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyLoginLogs_PlayerId_LoginDate",
                table: "DailyLoginLogs",
                columns: new[] { "PlayerId", "LoginDate" },
                unique: true);
