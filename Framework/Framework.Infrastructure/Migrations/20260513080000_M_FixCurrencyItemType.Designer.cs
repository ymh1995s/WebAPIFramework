...
namespace Framework.Infrastructure.Migrations
{
    ...
    [Migration("20260513080000_M_FixCurrencyItemType")]
    partial class M_FixCurrencyItemType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Framework.Domain.Entities.Item", b =>
                {
                    ...
                    b.Property<int?>("UseRewardTableId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Framework.Domain.Entities.PlayerQuestProgress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PlayerId", "PeriodKey")
                        .HasDatabaseName("IX_PlayerQuestProgresses_Player_PeriodKey");

                    b.HasIndex("PlayerId", "QuestId", "PeriodKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("Framework.Domain.Entities.QuestDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ConditionTargetId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ConditionType", "ConditionTargetId")
                        .HasDatabaseName("IX_QuestDefinitions_ConditionType_ConditionTargetId")
                        .HasFilter("\"IsActive\" = true AND \"IsDeleted\" = false");

                    b.HasIndex("Period", "IsActive", "IsDeleted")
            ...
            modelBuilder.Entity("Framework.Domain.Entities.Item", b =>
                {
                    b.HasOne("Framework.Domain.Entities.RewardTable", null)
                        .WithMany()
                        .HasForeignKey("UseRewardTableId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
            ...
            modelBuilder.Entity("Framework.Domain.Entities.PlayerQuestProgress", b =>
                {
                    ...
                    b.HasOne("Framework.Domain.Entities.QuestDefinition", "Quest")
                        .WithMany()
            ...
            modelBuilder.Entity("Framework.Domain.Entities.QuestDefinition", b =>
                {
                    b.HasOne("Framework.Domain.Entities.QuestDefinition", "PrerequisiteQuest")
                        .WithMany()
            ...
            modelBuilder.Entity("Framework.Domain.Entities.ShopProduct", b =>
                {
                    b.HasOne("Framework.Domain.Entities.Item", "PriceItem")
                        .WithMany()
