...
| 퀘스트 시스템 | 일일·주간·메인(영구) 퀘스트. QuestDefinition 마스터 + PlayerQuestProgress 진행 추적. 조건 자동 카운터(StageCleared/ItemUsed/ShopPurchased/Login), 보상 수령(RewardDispatcher Auto 모드), xmin 동시성 3회 재시도. Admin CRUD·플레이어 진행 조회 |
